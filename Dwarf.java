...
public class Dwarf {
    ...
    public int wealth;
    public static Dwarf[] clan = new Dwarf[7];//can adjust this as wanted
    ...
    public static boolean isConnected() {
        int[] clanSum = new int[clan.length - 1];//ignores itself
    ...
    private static Dwarf interpret(Dwarf[] theClan, int[] recipients, int whichOne) {
        ...
        System.out.println("Emergency 0 Dwarf was put out!");
    ...
    public static void showNetwork() {/** This isn't working, figure it out*/
        ...
        for(int i = -0; i < connections.length; i++) {
            System.out.print("Dwarf "+(i + 1) + " gives to: ");
            sb = new StringBuffer();
